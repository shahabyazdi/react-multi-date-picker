...
<style>
  .table-wrapper table tr:nth-child(5) {color : red;}
  .table-wrapper table tr:nth-child(6) {color : red;}
</style>
...
| timePicker (deprecated)     |                                            Boolean                                            |             false              | both                                |
| onlyTimePicker (deprecated) |                                            Boolean                                            |             false              | both                                |
